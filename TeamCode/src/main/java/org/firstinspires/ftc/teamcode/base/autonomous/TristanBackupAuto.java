...
public class TristanBackupAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action onePlusThreeBucket1 = drive.actionBuilder(new Pose2d(-39,-62.5, Math.toRadians(90)))
                ...
                .build();
        Action onePlusThreeBucket2 = drive.actionBuilder(new Pose2d(-59,-55, Math.toRadians(45)))
                // Go to sample zone 1
        ...
        Action onePlusThreeBucket3 = drive.actionBuilder(new Pose2d(-47,-56, Math.toRadians(90)))
                ...
                .strafeToLinearHeading(new Vector2d(-59,-55), Math.toRadians(45))
                .build();
        Action onePlusThreeBucket4 = drive.actionBuilder(new Pose2d(-59,-55, Math.toRadians(45)))
                // Sample zone 2
        ...
        Action onePlusThreeBucket5 = drive.actionBuilder(new Pose2d(-57.5,-56, Math.toRadians(93)))
                ...
                .strafeToLinearHeading(new Vector2d(-59,-55), Math.toRadians(45))
                .build();
        Action onePlusThreeBucket6 = drive.actionBuilder(new Pose2d(-59,-55, Math.toRadians(45)))
                // sample zone 3
        ...
        Action onePlusThreeBucket7 = drive.actionBuilder(new Pose2d(-65,-55, Math.toRadians(108)))
                ...
                .strafeToLinearHeading(new Vector2d(-59,-55), Math.toRadians(45))
                .build();
        Action onePlusThreeBucket8 = drive.actionBuilder(new Pose2d(-59,-55, Math.toRadians(45)))
                // park
