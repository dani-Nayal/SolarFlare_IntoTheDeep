...
public class MeepMeepTesting {
    ...
    public static void main(String[] args) {
        ...
        Action oneSpecimenPlusThreeSpecimen1 = myBot.getDrive().actionBuilder(new Pose2d(12.4375/2,-70+15.0625/2,Math.toRadians(90)))
                ...
                .splineToSplineHeading(new Pose2d(32,-39,Math.toRadians(45)),Math.toRadians(0))
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(38,-44,Math.toRadians(-45)),Math.toRadians(-45))
                .splineToSplineHeading(new Pose2d(46,-41,Math.toRadians(37)),Math.toRadians(45))
                .splineToLinearHeading(new Pose2d(51,-44,Math.toRadians(-45)),Math.toRadians(-45))
                .splineToSplineHeading(new Pose2d(56,-41,Math.toRadians(37)),Math.toRadians(45))
                .splineToLinearHeading(new Pose2d(58,-44,Math.toRadians(-45)),Math.toRadians(-45))
                .build();
